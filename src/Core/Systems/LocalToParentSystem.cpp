...
static void ChildLocalToWorld(World* w, const Ubpa::transformf& parent_l2w, Entity e) {
	Ubpa::transformf l2w;
	if (w->entityMngr.Have(e, Ubpa::TypeID_of<LocalToWorld>) && w->entityMngr.Have(e, Ubpa::TypeID_of<LocalToParent>)) {
	...
	if (w->entityMngr.Have(e, Ubpa::TypeID_of<Children>)) {
